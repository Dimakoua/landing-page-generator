...
describe('RecommendedProducts', () => {
  ...
  it('renders product cards and buttons', () => {
    ...
    safeRender(<RecommendedProducts products={products} title="Complete Your Setup" />);
  ...
  it('dispatches action when CTA clicked', () => {
    ...
    safeRender(<RecommendedProducts products={products} dispatcher={{ dispatch: mockDispatch } as any} />);
